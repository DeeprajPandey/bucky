...
var storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    cb(null, 'userVid' + path.extname(file.originalname));
  }
});
...
app.get('/uploadvideo', uploadController.uploadvideo);
...
//app.get('/uploadvideo', uploadController.getFileUpload);
//app.post('/uploadvideo', upload.single('file'), apiController.postFileUpload);
